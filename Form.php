...
class Form implements \ArrayAccess, \Iterator, \Countable
{
  ...
  public function embedForm($name, Form $form, $decorator = null)
  {
    ...
    $this->widgetSchema[$name] = new WidgetSchemaDecorator($widgetSchema, $decorator);
   ...
   */
  public function embedFormForEach($name, Form $form, $n, $decorator = null, $innerDecorator = null, $options = array(), $attributes = array(), $labels = array())
  {
    if (true === $this->isBound() || true === $form->isBound())
    {
      throw new \LogicException('A bound form cannot be embedded');
    ...
    $this->embeddedForms[$name] = new Form();
    ...
    $this->widgetSchema[$name] = new WidgetSchemaDecorator(new WidgetSchemaForEach(new WidgetSchemaDecorator($widgetSchema, $innerDecorator), $n, $options, $attributes), $decorator);
    $this->validatorSchema[$name] = new ValidatorSchemaForEach($form->getValidatorSchema(), $n);
  ...
  public function mergePreValidator(ValidatorBase $validator = null)
  {
    ...
    {
      $this->validatorSchema->setPreValidator(new ValidatorAnd(array(
  ...
  public function mergePostValidator(ValidatorBase $validator = null)
  {
    ...
    {
      $this->validatorSchema->setPostValidator(new ValidatorAnd(array(
  ...
  {
    $this->setWidgetSchema(new WidgetSchema($widgets));
   ...
   * @return sfForm The current form instance
   */
  public function setWidgetSchema(WidgetSchema $widgetSchema)
  {
  ...
  public function addCSRFProtection($secret = null)
  {
    ...
    $this->widgetSchema[self::$CSRFFieldName] = new WidgetInputHidden();
  ...
  public function getFormFieldSchema()
  {
    if (null === $this->formFieldSchema)
    {
      ...
      $this->formFieldSchema = new FieldSchema($this->widgetSchema, null, null, $values, $this->errorSchema);
    }
