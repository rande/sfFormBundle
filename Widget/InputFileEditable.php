...
/**
 * InputFileEditable represents an upload HTML input tag with the possibility
 * to remove a previously uploaded file.
 *
 * @package    symfony
 * @subpackage widget
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: InputFileEditable.class.php 24015 2009-11-16 13:33:34Z bschussek $
 */
class InputFileEditable extends InputFile
{
  /**
   * Constructor.
   *
