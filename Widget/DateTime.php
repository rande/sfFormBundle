...
/**
 * DateTime represents a datetime widget.
 *
 * @package    symfony
 * @subpackage widget
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: DateTime.class.php 20301 2009-07-19 10:57:32Z fabien $
 */
class DateTime extends Widget
{
   ...
   * Available options:
   *
   *  * date:      Options for the date widget (see Date)
   *  * time:      Options for the time widget (see Time)
   ...
   *
   * @return  A Widget representing the date
   */
  protected function getDateWidget($attributes = array())
  {
    return new Date($this->getOptionsFor('date'), $this->getAttributesFor('date', $attributes));
  }
   ...
   * @param  array $attributes  An array of attributes
   *
   * @return  A Widget representing the time
   */
  protected function getTimeWidget($attributes = array())
  {
    return new Time($this->getOptionsFor('time'), $this->getAttributesFor('time', $attributes));
  }
