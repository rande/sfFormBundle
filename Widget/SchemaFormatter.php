...
abstract class SchemaFormatter
{
   ...
   */
  public function __construct(Schema $widgetSchema)
  {
   ...
   *
   * @throws \InvalidArgumentException if an invalid php callable or Callable has been provided
   */
  static public function setTranslationCallable($callable)
  {
    if (!$callable instanceof Callable && !is_callable($callable))
    {
      throw new \InvalidArgumentException('Provided i18n callable should be either an instance of Callable or a valid PHP callable');
    }
   ...
   */
  public function setWidgetSchema(Schema $widgetSchema)
  {
