...
/**
 * FilterInput represents an HTML input tag used for filtering text.
 *
 * @package    symfony
 * @subpackage widget
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: FilterInput.class.php 24015 2009-11-16 13:33:34Z bschussek $
 */
class FilterInput extends Form
{
  /**
   * Constructor.
   *
