 ...
 */
class FieldSchema extends Field implements \ArrayAccess, \Iterator, \Countable
{
  protected
    $count      = 0,
    $fieldNames = array(),
   ...
   * Constructor.
   *
   * @param FormSchema $widget A sfWidget instance
   * @param Field        $parent The sfFormField parent instance (null for the root widget)
   * @param string             $name   The field name
   * @param string             $value  The field value
   * @param Error   $error  A Error instance
   */
  public function __construct(WidgetSchema $widget, Field $parent = null, $name, $value, ValidatorError $error = null)
  {
  ...
  public function getHiddenFields($recursive = true)
  {
    ...
    {
      if ($field instanceof FieldSchema && $recursive)
      {
