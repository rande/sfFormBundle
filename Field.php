...
class Field
{
   ...
   * @param ValidatorError $error  A ValidatorError instance
   */
  public function __construct(WidgetForm $widget, Field $parent = null, $name, $value, ValidatorError $error = null)
  {
    $this->widget = $widget;
    $this->parent = $parent;
    $this->name   = $name;
