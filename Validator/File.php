...
/**
 * File validates an uploaded file.
 *
 * @package    symfony
 * @subpackage validator
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: File.class.php 23951 2009-11-14 20:44:22Z FabianLange $
 */
class File extends Base
{
  ...
  protected function doClean($value)
  {
    ...
    {
      throw new Error($this, 'invalid', array('value' => (string) $value));
    }
    ...
    switch ($value['error'])
    {
      case UPLOAD_ERR_INI_SIZE:
        ...
        throw new Error($this, 'max_size', array('max_size' => $max, 'size' => (int) $value['size']));
      case UPLOAD_ERR_FORM_SIZE:
        throw new Error($this, 'max_size', array('max_size' => 0, 'size' => (int) $value['size']));
      case UPLOAD_ERR_PARTIAL:
        throw new Error($this, 'partial');
      case UPLOAD_ERR_NO_TMP_DIR:
        throw new Error($this, 'no_tmp_dir');
      case UPLOAD_ERR_CANT_WRITE:
        throw new Error($this, 'cant_write');
    ...
    {
      throw new Error($this, 'max_size', array('max_size' => $this->getOption('max_size'), 'size' => (int) $value['size']));
    }
    ...
    if ($this->hasOption('mime_types'))
    {
      ...
      {
        throw new Error($this, 'mime_types', array('mime_types' => $mimeTypes, 'mime_type' => $mimeType));
      }
    }
