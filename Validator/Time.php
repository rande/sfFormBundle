...
/**
 * Time validates a time. It also converts the input value to a valid time.
 *
 * @package    symfony
 * @subpackage validator
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @author     Fabian Lange <fabian.lange@symfony-project.com>
 * @version    SVN: $Id: Time.class.php 23810 2009-11-12 11:07:44Z Kris.Wallsmith $
 */
class Time extends Base
{
  ...
  protected function doClean($value)
  {
    ...
    else if ($regex = $this->getOption('time_format'))
    {
      ...
      {
        throw new Error($this, 'bad_format', array('value' => $value, 'time_format' => $this->getOption('time_format_error') ? $this->getOption('time_format_error') : $this->getOption('time_format')));
      }
  ...
  protected function convertTimeArrayToTimestamp($value)
  {
    ...
    if (false === $clean)
    {
      throw new Error($this, 'invalid', array('value' => var_export($value, true)));
    }
