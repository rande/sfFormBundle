...
/**
 * DateRange validates a range of date. It also converts the input values to valid dates.
 *
 * @package    symfony
 * @subpackage validator
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: DateRange.class.php 15966 2009-03-03 17:29:06Z hartym $
 */
class DateRange extends Base
{
  ...
  protected function doClean($value)
  {
    ...
    {
      $v = new SchemaCompare($fromField, SchemaCompare::LESS_THAN_EQUAL, $toField, array('throw_global_error' => true), array('invalid' => $this->getMessage('invalid')));
      $v->clean($value);
    }
