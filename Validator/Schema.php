...
/**
 * Schema represents an array of fields.
 *
 ...
 * @version    SVN: $Id: Schema.class.php 22446 2009-09-26 07:55:47Z fabien $
 */
class Schema extends Base implements \ArrayAccess
{
  protected
    $fields        = array(),
    $preValidator  = null,
   ...
   *
   *  * null
   *  * an array of named Base instances
   *
  ...
  public function __construct($fields = null, $options = array(), $messages = array())
  {
    ...
    {
      throw new \InvalidArgumentException('Schema constructor takes an array of Base objects.');
    }
  ...
  protected function doClean($values)
  {
    ...
    foreach ($values as $name => $value)
    {
      ...
      if (!array_key_exists($name, $this->fields))
      {
        ...
        {
          $errorSchema->addError(new Error($this, 'extra_fields', array('field' => $name)));
        }
   ...
   *
   * @return Base The current validator instance
   */
  public function setPreValidator(Base $validator)
  {
   ...
   * @return Base The current validator instance
   */
  public function setPostValidator(Base $validator)
  {
   ...
   * @param  string $name  The field name
   *
   * @return Base The Base instance associated with the given name, null if it does not exist
   */
  ...
  {
    if (!$validator instanceof Base)
    {
      throw new \InvalidArgumentException('A field must be an instance of Base.');
    }
   ...
   *
   * @return Base An array of Base instances
   */
  ...
  {
    throw new \Exception('Unable to convert a Schema to string.');
  }
