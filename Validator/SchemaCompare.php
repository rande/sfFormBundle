...
/**
 * SchemaCompare compares several values from an array.
 *
 * @package    symfony
 * @subpackage validator
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: SchemaCompare.class.php 21908 2009-09-11 12:06:21Z fabien $
 */
class SchemaCompare extends Schema
{
  const EQUAL              = '==';
  const NOT_EQUAL          = '!=';
  const IDENTICAL          = '===';
  ...
  protected function doClean($values)
  {
    ...
    if (!$valid)
    {
      $error = new Error($this, 'invalid', array(
      ...
      throw new ErrorSchema($this, array($this->getOption('left_field') => $error));
    }
