 ...
 * @version    SVN: $Id: Error.class.php 15393 2009-02-10 12:58:49Z fabien $
 */
class Error extends \Exception implements \Serializable
{
   ...
   */
  public function __construct(Base $validator, $code, $arguments = array())
  {
  ...
  public function getArguments($raw = false)
  {
    ...
    foreach ($this->arguments as $key => $value)
    {
      ...
      $arguments["%$key%"] = htmlspecialchars($value, ENT_QUOTES, Base::getCharset());
    }
