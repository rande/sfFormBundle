...
/**
 * Choice validates than the value is one of the expected values.
 *
 * @package    symfony
 * @subpackage validator
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @version    SVN: $Id: Choice.class.php 22264 2009-09-23 05:54:32Z fabien $
 */
class Choice extends Base
{
  ...
  protected function cleanMultiple($value, $choices)
  {
    ...
    foreach ($value as $v)
    {
      ...
      {
        throw new Error($this, 'invalid', array('value' => $v));
      }
    }
    ...
    {
      throw new Error($this, 'min', array('count' => $count, 'min' => $this->getOption('min')));
    }

    if ($this->hasOption('max') && $count > $this->getOption('max'))
    {
      throw new Error($this, 'max', array('count' => $count, 'max' => $this->getOption('max')));
    }
