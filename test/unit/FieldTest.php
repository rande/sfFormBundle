...
$errorSchema1 = new ValidatorErrorSchema(new ValidatorString());
$errorSchema1->addError(new ValidatorError(new ValidatorString(), 'error'), 'title1');
$parent1 = new FieldSchema($schema, null, 'article', array('title' => 'symfony'), $errorSchema1);
$f1 = $parent1['title'];
...
$authorErrorSchema = new ValidatorErrorSchema(new ValidatorString());
$authorErrorSchema->addError(new ValidatorError(new ValidatorString(), 'name error'), 'name');
$authorErrorSchema->addError(new ValidatorError(new ValidatorString(), 'non existent field error'), 'non_existent_field');
$authorErrorSchema->addError(new ValidatorError(new ValidatorString(), 'hidden field error'), 'id');
