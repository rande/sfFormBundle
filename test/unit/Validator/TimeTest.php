...
use Bundle\sfFormBundle\Validator\Time;
...
try
{
  ...
  $t->fail('->clean() throws a Error if the time is a string and is not parsable by strtotime');
  $t->skip('', 1);
}
catch (Error $e)
{
  $t->pass('->clean() throws a Error if the time is a string and is not parsable by strtotime');
...
try
{
  ...
  $t->fail('->clean() throws a Error if time date is not valid');
  $t->skip('', 1);
}
catch (Error $e)
{
...
{
  $v->clean('20.10-18');
  $t->fail('->clean() throws a Error if the time does not match the regex');
  $t->skip('', 2);
}
catch (Error $e)
{
  $t->pass('->clean() throws a Error if the time does not match the regex');
