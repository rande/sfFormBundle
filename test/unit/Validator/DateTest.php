...
try
{
  ...
  $t->fail('->clean() throws a Error if the date is a string and is not parsable by strtotime');
  $t->skip('', 1);
}
catch (Error $e)
{
  $t->pass('->clean() throws a Error if the date is a string and is not parsable by strtotime');
...
try
{
  ...
  $t->fail('->clean() throws a Error if the date is not valid');
  $t->skip('', 1);
}
catch (Error $e)
{
  $t->pass('->clean() throws a Error if the date is not valid');
  $t->is($e->getCode(), 'invalid', '->clean() throws a Error');
}
...
{
  $v->clean('2005-10-18');
  $t->fail('->clean() throws a Error if the date does not match the regex');
  $t->skip('', 2);
}
catch (Error $e)
{
  $t->pass('->clean() throws a Error if the date does not match the regex');
  ...
  $t->is($e->getCode(), 'bad_format', '->clean() throws a Error');
}
...
try
{
  ...
  $t->fail('->clean() throws a Error if the time is not valid');
}
catch (Error $e)
{
  $t->pass('->clean() throws a Error if the time is not valid');
}
