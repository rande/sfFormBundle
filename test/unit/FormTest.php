...
class TestForm1 extends FormTest
{
  public function configure()
  {
    ...
    $this->setWidgets(array(
      'a' => new WidgetInputText(),
      'b' => new WidgetInputText(),
      'c' => new WidgetInputText(),
    ));
    $this->setValidators(array(
      'a' => new ValidatorString(array('min_length' => 2)),
      'b' => new ValidatorString(array('max_length' => 3)),
      'c' => new ValidatorString(array('max_length' => 1000)),
    ));
...
class TestForm2 extends FormTest
{
  public function configure()
  {
    $this->disableCSRFProtection();
    $this->setWidgets(array(
      'c' => new WidgetTextarea(),
      'd' => new WidgetTextarea(),
    ));
    $this->setValidators(array(
      'c' => new ValidatorPass(),
      'd' => new ValidatorString(array('max_length' => 5)),
    ));
    $this->getWidgetSchema()->setLabels(array(
      'c' => '2_c',
      'd' => '2_d',
    ...
    $this->validatorSchema->setPreValidator(new ValidatorPass());
    $this->validatorSchema->setPostValidator(new ValidatorPass());
  }
}
...
$t->diag('__construct');
$f = new FormTest();
$t->ok($f->getValidatorSchema() instanceof ValidatorSchema, '__construct() creates an empty validator schema');
$t->ok($f->getWidgetSchema() instanceof WidgetSchema, '__construct() creates an empty widget form schema');

$f = new Form(array('first_name' => 'Fabien'));
...
$t->is($v[Form::getCSRFFieldName()]->getOption('token'), '*secret*', '__construct() takes a CSRF secret as its second argument');
...
$f = new FormTest();
$validators = array(
  'first_name' => new ValidatorPass(),
  'last_name' => new ValidatorPass(),
);
...
$f = new FormTest();
$widgets = array(
  'first_name' => new WidgetInputText(),
  'last_name'  => new WidgetInputText(),
);
...
$f = new FormTest();
$f->setWidgetSchema(new WidgetSchema(array(
  'first_name' => new WidgetInputText(array('default' => 'Fabien')),
  'last_name'  => new WidgetInputText(),
  'image'      => new WidgetInputFile(),
)));
$f->setValidatorSchema(new ValidatorSchema(array(
  'first_name' => new ValidatorPass(),
  'last_name'  => new ValidatorPass(),
  'image'      => new ValidatorPass(),
)));
$f->setDefaults(array(
  'image' => 'default.gif',
));
...
$w['first_name'] = new WidgetInputText();
...
$f = new FormTest();
$f->setValidatorSchema(new ValidatorSchema(array(
  'first_name' => new ValidatorString(array('min_length' => 2)),
  'last_name' => new ValidatorString(array('min_length' => 2)),
)));
...
$f = new FormTest();
$f->setValidatorSchema(new ValidatorSchema(array(
  1 => new ValidatorString(array('min_length' => 2)),
  2 => new ValidatorString(array('min_length' => 2)),
)));
...
$f->setValidatorSchema(new ValidatorSchema(array(
  1 => new ValidatorString(array('min_length' => 2)),
  2 => new ValidatorString(array('min_length' => 2)),
  'file' => new ValidatorFile(array('max_size' => 2)),
)));
$f->setWidgetSchema(new WidgetSchema(array('file' => new WidgetInputFile())));
...
$pf->setValidatorSchema(new ValidatorSchema()); //cleaning ValidatorSchema to silence `_token_`

$ef = new FormTest(); //embed form

$ef->setValidatorSchema(new ValidatorSchema(array(
  1 => new ValidatorString(array('min_length' => 2)),
  2 => new ValidatorString(array('min_length' => 2)),
  'file' => new ValidatorFile(array('max_size' => 2)),
)));
$ef->setWidgetSchema(new WidgetSchema(array('file' => new WidgetInputFile())));
$pf->embedForm('ef', $ef);
...
$f->setWidgets(array(
  'id'         => new WidgetInputHidden(array('default' => 3)),
  'first_name' => new WidgetInputText(array('default' => 'Thomas')),
  'last_name'  => new WidgetInputText(),
));
...
$t->diag('->renderUsing()');
$f = new Form();
$f->setWidgets(array('name' => new WidgetInputText()));
$output = <<<EOF
<li>
...
$f->setWidgets(array(
  'id' => new WidgetInputHidden(),
  'name' => new WidgetInputText(),
  'is_admin' => new WidgetInputHidden(),
));
...
$company->setWidgetSchema($company_widget_schema = new WidgetSchema(array('name' => new WidgetInputText())));
$company->setValidatorSchema($company_validator_schema = new ValidatorSchema(array('name' => new ValidatorString(array('min_length' => 2)))));

$article = new FormTest();
$article->setWidgetSchema($article_widget_schema = new WidgetSchema(array('title' => new WidgetInputText())));
$article->setValidatorSchema($article_validator_schema = new ValidatorSchema(array('title' => new ValidatorString(array('min_length' => 2)))));
...
$t->is($v['author'][Form::getCSRFFieldName()], null, '->embedForm() removes the CSRF token for the embedded form');
$t->is($w['author'][Form::getCSRFFieldName()], null, '->embedForm() removes the CSRF token for the embedded form');
...
$t->diag('__clone()');
$a = new FormTest();
$a->setValidatorSchema(new ValidatorSchema(array(
  'first_name' => new ValidatorString(array('min_length' => 2)),
)));
...
class MyWidget extends WidgetForm
{
