...
// ::escapeOnce()
$t->diag('::escapeOnce()');
$t->is(Widget::escapeOnce('This a > text to "escape"'), 'This a &gt; text to &quot;escape&quot;', '::escapeOnce() escapes an HTML strings');
$t->is(Widget::escapeOnce(Widget::escapeOnce('This a > text to "escape"')), 'This a &gt; text to &quot;escape&quot;', '::escapeOnce() does not escape an already escaped string');
$t->is(Widget::escapeOnce('This a &gt; text to "escape"'), 'This a &gt; text to &quot;escape&quot;', '::escapeOnce() does not escape an already escaped string');
...
$t->is(Widget::escapeOnce(new MyClass()), 'mycontent', '::escapeOnce() converts objects to string');

// ::fixDoubleEscape()
$t->diag('::fixDoubleEscape()');
$t->is(Widget::fixDoubleEscape(htmlspecialchars(htmlspecialchars('This a > text to "escape"'), ENT_QUOTES, Widget::getCharset()), ENT_QUOTES, Widget::getCharset()), 'This a &gt; text to &quot;escape&quot;', '::fixDoubleEscape() fixes double escaped strings');

// ::getCharset() ::setCharset()
$t->diag('::getCharset() ::setCharset()');
$t->is(Widget::getCharset(), 'UTF-8', '::getCharset() returns the charset to use for widgets');
Widget::setCharset('ISO-8859-1');
$t->is(Widget::getCharset(), 'ISO-8859-1', '::setCharset() changes the charset to use for widgets');

// ::setXhtml() ::isXhtml()
$t->diag('::setXhtml() ::isXhtml()');
$w = new MyWidget();
$t->is(Widget::isXhtml(), true, '::isXhtml() return true if the widget must returns XHTML tags');
Widget::setXhtml(false);
