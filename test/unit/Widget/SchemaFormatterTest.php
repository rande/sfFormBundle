...
class MyFormatter extends SchemaFormatter
{
  protected
    $rowFormat       = "<li>\n  %error%%label%\n  %field%%help%\n%hidden_fields%</li>\n",
    $errorRowFormat  = "<li>\n%errors%</li>\n",
...
class MyFormatter2 extends SchemaFormatter
{
  
}

$f = new MyFormatter2(new Schema(array()));
