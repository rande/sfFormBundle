...
// ->render()
$t->diag('->render()');
$w = new Choice(array('choices' => array('foo' => 'bar')));
...
$w = new Choice(array('choices' => array('foo' => 'bar', 'foobar' => 'foo')));
$w->setParent($ws);
...
// __clone()
$t->diag('__clone()');
$w = new Choice(array('choices' => new Callable(array($w, 'foo'))));
$w1 = clone $w;
...
$w = new Choice(array('choices' => new Callable(array($a = new stdClass(), 'foo'))));
$w1 = clone $w;
$callable = $w1->getOption('choices')->getCallable();
