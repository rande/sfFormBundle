...
use Bundle\sfFormBundle\Widget\DateTime;
...
$w = new DateTime(array('with_time' => true, 'time' => array('with_seconds' => true)));
...
$w = new DateTime(array('with_time' => false));
$dom->loadHTML($w->render('foo', '2005-10-15 12:30:35'));
$css = new DomCssSelector($dom);
...
$w = new DateTime(array('date' => 'a string'));
try
{
  $w->render('foo');
